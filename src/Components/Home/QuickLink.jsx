...
const QuickLink = () => {
 ...
 return(
    ...
    <div className="card-container">
        ...
        <div className="card add" style={{background: 'hsl(197, 71%, 96%)', border: '1px solid hsl(197, 71%, 94%)'}}>
            <div className="content" style={{color: '#4da6ff'}}>
                <FaTasks size={20} />
                <div style={{marginTop: '.5rem'}}>New Tasks</div>
            </div>
        </div>
        <div className="card add" style={{background: 'hsl(75, 82%, 93%)', border: '1px solid hsl(75, 82%, 73%)'}}>
